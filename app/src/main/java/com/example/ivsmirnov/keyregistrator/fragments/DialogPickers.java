...
public class DialogPickers extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewPager viewPager = (ViewPager)pagerView.findViewById(R.id.preference_item_grid_size_page_picker);
        ...
        Toolbar toolbar = (Toolbar)pagerView.findViewById(R.id.preference_item_grid_size_toolbar);
        ...
        TabLayout tabLayout = (TabLayout)pagerView.findViewById(R.id.preference_item_grid_size_tabs);
